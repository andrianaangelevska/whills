...
Raftr is a social media platform for groups on campuses. Think Meetup and Facebook groups for colleges. They have 2 mobile apps and react web application. These allow users to interact, post events and manage groups on campus. These groups are known as rafts. Examples are "Class of 22", "Debate Club", ect..
